...
class PickUpOrderDetail extends StatefulWidget {
  PickUpOrderDetail({super.key,required this.data});
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            children: [
              ...
              BlocBuilder<PickUpServiceBlo,PickUpServiceState>(builder: (context, state) {
