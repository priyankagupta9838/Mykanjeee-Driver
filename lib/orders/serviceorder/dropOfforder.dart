...
class DropOffOrder extends StatefulWidget {
  const DropOffOrder({Key? key}) : super(key: key);

  @override
  State<DropOffOrder> createState() => _DropOffOrderState();
}

class _DropOffOrderState extends State<DropOffOrder> {
  ...
  Future<void> fetchOrders() async {
    final response = await  CheckOut().allDropOffServiceOrder("QUOTE","COLLECTED",page,5);
    setState(() {
      loading = false;
        ...
        child: ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            if (index == orderData.length && hasMore) {
              ...
              return InkWell(
                onTap: () {
                  Navigator.pushNamed(context, RoutesName.dropOffOderDetail,
