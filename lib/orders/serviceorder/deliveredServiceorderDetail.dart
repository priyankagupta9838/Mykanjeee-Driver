...
class DeliveredServiceOrderDetail extends StatefulWidget {
  DeliveredServiceOrderDetail({super.key,required this.data});
  Map<dynamic,dynamic>data;
  @override
  State<DeliveredServiceOrderDetail> createState() => _DeliveredServiceOrderDetailState();
}
class _DeliveredServiceOrderDetailState extends State<DeliveredServiceOrderDetail> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar:AppBar(
        ...
        title:  AutoSizeText("Delivered Service Order Details",style: GoogleFonts.roboto(
            color: Colors.white,
              ...
              Row(
                ...
                children: [
                  ...
                  widget.data["order_data"]["time_slot"].toString()
                      :
                  "Day",style: GoogleFonts.openSans(
                      color: Colors.black54,
                      fontSize: size.height*0.019,
                      fontWeight: FontWeight.w500
                  ),),
