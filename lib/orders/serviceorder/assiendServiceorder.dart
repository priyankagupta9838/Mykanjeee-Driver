...
class AssignedServiceOrder extends StatefulWidget {
  const AssignedServiceOrder({Key? key}) : super(key: key);

  @override
  State<AssignedServiceOrder> createState() => _AssignedServiceOrderState();
}

class _AssignedServiceOrderState extends State<AssignedServiceOrder> {
  ...
  Future<void> fetchOrders() async {
    final response = await CheckOut().allAssignedServiceOrder("QUOTE", "ASSIGNED", page, 5);
    setState(() {
      loading = false;
        ...
        child: ListView.builder(
          ...
          itemBuilder: (context, index) {
            if (index == orderData.length) {
              ...
              return InkWell(
                onTap: () {
                  Navigator.pushNamed(context, RoutesName.assignedServiceOrderDetail,
