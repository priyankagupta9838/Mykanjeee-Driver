...
class DeliveredServiceOrder extends StatefulWidget {
  const DeliveredServiceOrder({Key? key}) : super(key: key);
...
class _DeliveredServiceOrderState extends State<DeliveredServiceOrder> {
  ...
  Future<void> fetchOrders() async {
    final response = await CheckOut().allDeliveredServiceOrder("QUOTE","DELIVERED",page,5);
    setState(() {
      loading = false;
        ...
        child: ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            if (index == orderData.length && hasMore) {
              ...
              return InkWell(
                onTap: () {
                  Navigator.pushNamed(context, RoutesName.deliveredServiceOderDetail,
