...
class AcceptedServiceOrderDetail extends StatefulWidget {
  AcceptedServiceOrderDetail({super.key,required this.data});
  Map<dynamic,dynamic>data;
  @override
  State<AcceptedServiceOrderDetail> createState() => _AcceptedServiceOrderDetailState();
}
class _AcceptedServiceOrderDetailState extends State<AcceptedServiceOrderDetail> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar:AppBar(
        ...
        title:  AutoSizeText("Collected Service Order Details",style: GoogleFonts.roboto(
            color: Colors.white,
